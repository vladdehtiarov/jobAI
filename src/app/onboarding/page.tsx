...
type Form = { id: string; full_name: string; target_role: string; target_salary_usd: string; linkedin_url: string }

export default function OnboardingPage() {
  const [form, setForm] = useState<Form>({ id: '00000000-0000-0000-0000-000000000000', full_name:'', target_role:'', target_salary_usd:'', linkedin_url:'' })
